(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var config = { url: 'http://192.168.5.132:3000', options: {} };
            var routes = [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InitComponent = /** @class */ (function () {
                function InitComponent(initService) {
                    var _this = this;
                ...
                InitComponent.prototype.toggle = function () {
                    this.show = !this.show;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LayoutComponent = /** @class */ (function () {
                function LayoutComponent(socketService, initService, layoutService, render) {
                ...
                LayoutComponent.prototype.initResize = function () {
                ...
                LayoutComponent.prototype.drawLine = function (x0, y0, x1, y1, color1, style, fontSize, emit) {
                    console.log(x0, y0);
                ...
                LayoutComponent.prototype.onDrawingEvent = function (data) {
                    var w = this.canvas.width;
                    var h = this.canvas.height;
                    console.log(w);
                ...
                LayoutComponent.prototype.onMouseDown = function (e) {
                    // console.log(e);
                    this.drawing = true;
                    this.current.x = e.clientX || e.touches[0].clientX;
                    this.current.y = e.clientY || e.touches[0].clientY;
                };
                LayoutComponent.prototype.onMouseUp = function (e) {
                    if (!this.drawing) {
                        return;
                    }
                    this.drawing = false;
                ...
                LayoutComponent.prototype.onMouseMove = function (e) {
                    if (!this.drawing) {
                        return;
                    }
                    this.drawLine(this.current.x, this.current.y, e.clientX || e.touches[0].clientX, e.clientY || e.touches[0].clientY, this.current.color, this.current.lineStyle, this.current.fontSize, true);
                ...
                LayoutComponent.prototype.onFontSizeUpdate = function (e) {
                    this.current.fontSize = e;
                };
                LayoutComponent.prototype.onColorUpdate = function (e) {
                    // this.current.color = e.target.className.split(' ')[1];
                    this.current.color = e.hex;
                };
                LayoutComponent.prototype.onLineStyleUpdate = function (e) {
                    this.current.lineStyle = e;
                };
                LayoutComponent.prototype.onBGimgUpdate = function (e, emit) {
                    var _this = this;
                    var image = new Image();
                    image.onload = function () {
                        // this.context.drawImage(image, 0, 0, this.canvas.width, this.canvas.height);
                        var top = _this.canvas.height * 0.10;
                        var left = _this.canvas.width * 0.05;
                        var imgHeight = _this.canvas.height * 0.50;
                        var imgWidth = _this.canvas.width * 0.50;
                        console.log('Top : ' + top);
                        console.log('Left : ' + left);
                        _this.context.drawImage(image, left, top, imgWidth, imgHeight);
                    };
                    image.src = e.data;
                    this.sendImage(e, emit);
                };
                LayoutComponent.prototype.sendImage = function (e, emit) {
                    if (emit) {
                        this.sendMsg(e);
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LeftNavComponent = /** @class */ (function () {
                ...
                LeftNavComponent.prototype.toggle = function () {
                    this.initService.viewLeft();
                };
                LeftNavComponent.prototype.toggleColor = function (item) {
                    this.initService.setLineColor(item);
                };
                LeftNavComponent.prototype.fontSizeChange = function (event) {
                    this.initService.setLineSize(event);
                };
                LeftNavComponent.prototype.toggleLineStyle = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InitService = /** @class */ (function () {
                ...
                InitService.prototype.viewLeft = function () {
                    this.toggleLeft.emit({});
                };
                InitService.prototype.setLineColor = function (item) {
                    this.lineColor.emit(item);
                };
                InitService.prototype.setLineSize = function (item) {
                    this.lineSize.emit(item);
                };
                InitService.prototype.setLineStyle = function (item) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LayoutService = /** @class */ (function () {
                ...
                LayoutService.prototype.viewImg = function (item) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var RightNavService = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UploadModalComponent = /** @class */ (function () {
                ...
                UploadModalComponent.prototype.ngOnDestroy = function () {
                    this.modalService.remove(this.id);
                    this.element.remove();
                };
                // open modal
                UploadModalComponent.prototype.open = function () {
                    this.element.style.display = 'block';
                    document.body.classList.add('jw-modal-open');
                };
                // close modal
                UploadModalComponent.prototype.close = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UploadModalModule = /** @class */ (function () {
                function UploadModalModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UploadModalService = /** @class */ (function () {
                ...
                UploadModalService.prototype.add = function (modal) {
                    // add modal to array of active modals
                    this.modals.push(modal);
                };
                UploadModalService.prototype.remove = function (id) {
                    // remove modal from array of active modals
                    this.modals = this.modals.filter(function (x) { return x.id !== id; });
                };
                UploadModalService.prototype.open = function (id) {
                    // open modal specified by id
                    var modal = this.modals.find(function (x) { return x.id === id; });
                    modal.open();
                };
                UploadModalService.prototype.close = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UploadViewComponent = /** @class */ (function () {
                function UploadViewComponent(modalService, layoutService) {
                    this.modalService = modalService;
                    this.layoutService = layoutService;
                }
                UploadViewComponent.prototype.ngOnInit = function () {
                };
                UploadViewComponent.prototype.preview = function (files) {
                    var _this = this;
                    console.log(files);
                    if (files.length === 0) {
                        return;
                ...
                UploadViewComponent.prototype.addBGimage = function (item) {
                    this.layoutService.viewImg({ type: 'bgImage', data: this.imgURL });
                    this.closeModal('custom-modal-1');
                };
                UploadViewComponent.prototype.openModal = function (id) {
                    this.modalService.open(id);
                };
                UploadViewComponent.prototype.closeModal = function (id) {
                    this.imagePath = '';
                    this.imgURL = '';
            ...
            UploadViewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var UploadViewService = /** @class */ (function () {
                function UploadViewService() {
                }
